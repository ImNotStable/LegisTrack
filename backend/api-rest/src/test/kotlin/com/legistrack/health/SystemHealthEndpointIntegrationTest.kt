...
/**
 * Integration test focused on the /api/system/health endpoint contract. Uses mocked
 * dependencies to avoid network / database calls while asserting:
 *  - HTTP 200
 *  - Echo of X-Correlation-Id header
 *  - correlationId field in JSON body
 *  - presence of expected congress snapshot keys
 */
class SystemHealthControllerUnitTest {
