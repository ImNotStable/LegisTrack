					...
					<div className="mb-4">
						...
						<div className="w-full bg-gray-200 rounded-full h-2 mb-2">
							<div className="flex h-2 rounded-full overflow-hidden">
								<div className="bg-blue-500" style={{ width: `${democraticPercentage}%` }} />
								<div className="bg-red-500" style={{ width: `${republicanPercentage}%` }} />
								<div
						...
						<div className="flex justify-between text-xs text-gray-600">
							<span>
								D: {document.partyBreakdown.democratic} ({democraticPercentage.toFixed(1)}%)
							</span>
							<span>
								R: {document.partyBreakdown.republican} ({republicanPercentage.toFixed(1)}%)
							</span>
