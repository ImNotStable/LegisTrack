...
export const DocumentCard: React.FC<DocumentCardProps> = memo(({ document }) => {
  ...
  const formattedDate = useMemo(() => formatShortDate(document.introductionDate), [document.introductionDate]);
      ...
      <div className="p-6">
        ...
        {totalSponsors > 0 && (
          <section className="mb-4" aria-labelledby="sponsors-heading">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 mb-2" role="progressbar" aria-label="Party breakdown">
            ...
            <div className="flex justify-between text-xs text-gray-600">
              <span>D: {democratic} ({democraticPercentage.toFixed(1)}%)</span>
              <span>R: {republican} ({republicanPercentage.toFixed(1)}%)</span>
              {independent > 0 && (
                <span>I: {independent}</span>
              )}
            </div>
          </section>
        )}
        ...
        {document.industryTags.length > 0 && (
          <section className="mb-4" aria-labelledby="tags-heading">
            <div className="flex items-center mb-2">
              ...
              <h3 id="tags-heading" className="text-sm text-gray-600">Industry Tags</h3>
            </div>
