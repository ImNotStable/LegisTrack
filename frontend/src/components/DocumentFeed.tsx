...
export const DocumentFeed: React.FC = () => {
	...
	const { data, isLoading, error, isFetching, fetchNextPage } = useInfiniteDocuments(
		20,
		sortBy,
		sortDir
	);
	...
	useEffect(() => {
		...
		try {
			...
			// Safe to ignore: IntersectionObserver not critical for functionality; falls back to manual pagination.
		}
