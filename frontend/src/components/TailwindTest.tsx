...
export const TailwindTest = () => {
  return (
    <div className="hidden">
      ...
      <div className="bg-gradient-to-br from-blue-400 via-blue-300 to-blue-200">Democratic High</div>
      ...
      <div className="bg-gradient-to-br from-purple-400 via-purple-300 to-purple-200">Mixed Support</div>
