							...
							<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
								<div className="flex justify-between h-16">
									<div className="flex items-center">
										<h1 className="text-xl font-bold text-gray-900">LegisTrack</h1>
										<span className="ml-2 text-sm text-gray-500">
											U.S. Legislation Tracking & Analysis
										</span>
									</div>
									<div className="flex items-center space-x-4">
										<span className="text-sm text-gray-600">Powered by AI Analysis</span>
									</div>
								</div>
							</div>
						</nav>
						...
						<footer className="bg-white border-t border-gray-200 mt-12">
							<div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
								<div className="text-center text-sm text-gray-500">
									<p>LegisTrack - Personal U.S. Legislation Tracking System</p>
									<p className="mt-1">
